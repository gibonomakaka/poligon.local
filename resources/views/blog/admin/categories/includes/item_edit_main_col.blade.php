        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a href="#maindata" data-toggle="tad" role="tab" class="nav-link active">Основные данные</a>
                    </li>
                </ul>
                <br>
                <div class="tab-content">
                    <div class="tab-panel active" id="maindata" role="tabpanel">
                        <div class="form-group">
                            ...
                            <input name="title" type="text" value="{{$item->title}}" id="title" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <select name="parent_id" type="text" id="parent_id" class="form-control"
